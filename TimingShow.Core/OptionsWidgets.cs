...
{
    // Small IMGUI toolkit shared by the settings window: foldouts, sliders, toggles, color pickers.
    internal static class OptionsWidgets
    {
        ...
        // A button that is drawn bold while it represents the active choice.
